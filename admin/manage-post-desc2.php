...
<div class="container bg-white shadow mb-5">
    ...
    if( mysqli_num_rows($result) > 0){
        ...
        <td>   <?php
                $edit_icon = "<a href='edit-post-desc2.php?id={$p_id}' class='btn-sm btn-primary float-right '> <span ><i class='fa fa-edit '></i></span> </a>";
                $delete_icon = " <a href='delete-post2.php?id={$p_id}&category={$p_cat}' id='bin' class='btn-sm btn-danger float-right ml-3 '> <span ><i class='fa fa-trash '></i></span> </a>";
