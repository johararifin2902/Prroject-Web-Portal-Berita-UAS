        ...
        <div class="header">    
            <div class="header-content clearfix">
               ...
               <div class="text-center">
                <h2 class="pt-3"> JD News Admin </h2>
                 </div>
                   ...
                   <br> <br>       
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./add-category2.php"> <i class="icon-plus menu-icon"></i>Add Category</a></li>
                            <li><a href="./manage-category2.php"><i class="fa fa-cog menu-icon"></i>Manage Category</a></li>
                        </ul>
                    </li>
                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./add-post-desc2.php"> <i class="icon-plus menu-icon"></i>Add Post Description</a></li>
                            <li><a href="./manage-post-desc2.php"><i class="fa fa-cog menu-icon"></i>Manage Post Description</a></li>
                        </ul>
                    </li>
                    ...
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./add-post-details2.php"><i class="icon-plus menu-icon"></i>Add Post</a></li>
                            <li><a href="./manage-post-details2.php"><i class="fa fa-cog menu-icon"></i>Manage Post</a></li>
