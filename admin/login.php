...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($email) && !empty($pass)) {
        ...
        $sql_query = "SELECT * FROM admin WHERE email='$email' AND password='$encrypted_pass'";
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($rows = mysqli_fetch_assoc($result)) {
                ...
                // Redirect to index-admin.php if email is admin1@gmail.com
                if ($rows["email"] == "johar290204@gmail.com" || $rows["email"] == "admin@admin.com") {
                            ...
                            <div class="card-body pt-5 shadow">
                                ...
                                <form method="POST" action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                                    <div class="form-group">
                                        <label>Email :</label>
                                        <input type="email" class="form-control" value="<?php echo $email; ?>" name="email" placeholder="Max 24 character">
                                        <?php echo $email_err; ?>            
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <p class="text-center">Kembali ke Halaman Home? <a href="../index.php">Home</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
